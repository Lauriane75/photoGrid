...
class CreateHomeViewOutlets {
    ...
    func implementOutlets(vc: HomeViewController) {
        ...
        // Title
        vc.titleLabel = custom.returnLabel(font: Constants.thirstySoftRegular, text: data.title, view: vc.view)
        ...
        // Swipe up
        vc.swipeUpLabel = custom.returnLabel(font: Constants.delmMedium, text: data.swipeText, view: vc.view)
        ...
        vc.photoContentStackView = custom.returnStackView(backgroundColor: Constants.blueDark, view: vc.view)
        ...
        // UpHStackView
        vc.upHStackView = custom.returnStackView(backgroundColor: Constants.blueDark, view: vc.view)
        constraints.upHStackViewConstraints(upHStackView: vc.upHStackView, photoContentStackView: vc.photoContentStackView)

        // PlusUpLeftButton
        vc.plusUpLeftButton = custom.returnButton(image: Constants.plusImage, background: .clear, view: vc.view)
        ...
        // PlusUpRightButton
        vc.plusUpRightButton = custom.returnButton(image: Constants.plusImage, background: .clear, view: vc.view)
        ...
        // PlusUpLargeButton
        vc.plusUpLargeButton = custom.returnButton(image: Constants.plusImage, background: Constants.whiteGray, view: vc.view)
        ...
        // DownHStackView
        vc.downHStackView = custom.returnStackView(backgroundColor: Constants.blueDark, view: vc.view)
        constraints.downHStackViewConstraints(downHStackView: vc.downHStackView, photoContentStackView: vc.photoContentStackView)

        // PlusDownLeftButton
        vc.plusDownLeftButton = custom.returnButton(image: Constants.plusImage, background: .clear, view: vc.view)
        ...
        // PlusDownRightButton
        vc.plusDownRightButton = custom.returnButton(image: Constants.plusImage, background: .clear, view: vc.view)
        ...
        // PlusDownLargeButton
        vc.plusDownLargeButton = custom.returnButton(image: Constants.plusImage, background: Constants.whiteGray, view: vc.view)
        ...
        vc.selectedModeHStackView = custom.returnStackView(backgroundColor: .clear, view: vc.view)
